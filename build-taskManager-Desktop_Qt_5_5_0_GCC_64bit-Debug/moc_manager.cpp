...
QT_MOC_LITERAL(3, 18, 12) // "QStringList*"
    ...
    "Manager\0sendList\0\0QStringList*"
};
...
void Manager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendList((*reinterpret_cast< QStringList*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Manager::*_t)(QStringList * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Manager::sendList)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Manager::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_Manager.data,
...
// SIGNAL 0
void Manager::sendList(QStringList * _t1)
{
